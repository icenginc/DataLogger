...
def repeatThis(channel, dictionaryData):
    ...
    #print("RepeatThis: " + str(channel))
    #rawData = readFromDatabase(str(channel))
    #print(rawData)
    #dataR = rawData[4]
    ...
    #if ('min' + str(channel)) in dictionaryData:
    #    minD = dictionaryData['min' + str(channel)]
    #if ('max' + str(channel)) in dictionaryData:
    #    maxD = dictionaryData['max' + str(channel)]
    #if ('unit' + str(channel)) in dictionaryData:
    #    unit = dictionaryData['unit' + str(channel)]


    #if data.find(":") != -1 and unit.find(",") != -1:
    if data.find(":") != -1:
		temp2 = data.split(":")
